...
public class GroceryStore {
    ...
    //Deklarasi Class Plant dan Deklarasi masing masing Tipe Data yang digunakan
    static class Plant {
        private String name;
    ...
    //Deklarasi Class Fruit dan Deklarasi masing masing Tipe Data yang digunakan
    ...
    //Deklarasi Class Aple dan Deklarasi masing masing Tipe Data yang digunakan
    ...
    public static void main(String[] args) {
        ...
        //Membuat Array Fruits Basket
        List<? super Fruit> fruitsBasket = new ArrayList<>();
        //Mengisi Array Fruits basket dengan fungsi fill
        store.fill(fruitsBasket);

        //Mengecek Besar Size Fruits Basket
        assert(fruitsBasket.size() == 3);

        //Memasukkan array another basket
        ...
        //Mengecek zise fruit yang terbesar
        assert(store.getBiggestFruit(anotherBasket).getSize() == 9);
    }

    //Fungsi fill untuk mengisi fruits basket
    ...
    //Fungsi untuk mengecek fruit terbesar
    public Fruit getBiggestFruit(List<? extends Fruit> fruits) {
        ...
        //Mengecek adanya fruits
        assert(!fruits.isEmpty());
        //Menghitung iterasi banyak fruits
        int len = fruits.size();
        //mengambil data Array fruits dari 0
        Fruit biggestFruit = fruits.get(0);
        //Iterasi fruit sampai integer len
        for (int i = 1; i < len; i++) {
            //mencari Fruit terbesar
            if (fruits.get(i).getSize() > biggestFruit.getSize()) {
                biggestFruit = fruits.get(i);
            }
        }
        //data return biggestFruit
        return biggestFruit;
    }
}